...
@app.on_edited_message(filters.command(["eval", "g"]) & filters.user(OWNER_ID) & ~filters.forwarded & ~filters.via_bot)
@app.on_message(filters.command(["eval", "g"]) & filters.user(OWNER_ID) & ~filters.forwarded & ~filters.via_bot)
...
async def update(_, message):
    ...
    os.execl(sys.executable, sys.executable, "-m", "Grabber")
